...
struct NpsPark {
    ...
    #[serde(default)]
    activities: Vec<NpsActivity>,
    contacts: Option<NpsContacts>,
}
...
struct NpsHours {
    ...
    standard_hours: Option<serde_json::Value>,
}
...
const NPS_API_BASE: &str = "https://developer.nps.gov/api/v1/parks";
...
fn format_response(response: &NpsResponse) -> String {
